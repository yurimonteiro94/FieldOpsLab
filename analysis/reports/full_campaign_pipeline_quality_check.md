...
| step_count | 22 |
| failed_step_count | 0 |
| required_output_file_count | 10 |
| required_quality_file_count | 10 |

## Output checks

| Path | Exists | Size bytes |
| --- | --- | ---: |
| `analysis\reports\full_campaign_pipeline_report.md` | yes | 2644 |
| `analysis\reports\full_campaign_pipeline_manifest.json` | yes | 24153 |
| `analysis\reports\full_campaign_pipeline_log.txt` | yes | 21786 |
| `analysis\reports\campaign_execution_index.json` | yes | 51404 |
