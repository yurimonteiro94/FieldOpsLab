...
However, this is not yet enough for a research conclusion. The ranking configuration is still limited, the sample size is small, and the current scenarios are handcrafted examples rather than a broad experimental campaign.
